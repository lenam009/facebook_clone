...
import { getUserCurrentSelector, setUser as setUserRedux } from '@/redux/userSlice';
    ...
    return (
        <div className={cx('wrapper')}>
            <Image
                ...
                className={cx('img')}
                alt="error"
                src={'../assets/post/' + user?.coverPicture}
            ...
            <Flex vertical align="center" className={cx('wrapper-avatar')}>
                <Avatar
                    size={156}
                    icon={<UserOutlined />}
                    src={user?.profilePicture ? '../assets/person/' + user.profilePicture : ''}
                />
